...
function searchMeal(e) {
  ...
  if (term.trim()) {
    fetch("https://www.themealdb.com/api/json/v1/1/search.php?s=".concat(term)).then(function (res) {
      ...
      resultHeading.innerHTML = "<h2>Search results for '".concat(term, "':</h2>");

      if (data.meals === null) {
        resultHeading.innerHTML = "<p>There are no results for '".concat(term, "'.</p>");
      } else {
        mealsEl.innerHTML = data.meals.map(function (meal) {
          return "<div class = \"meal\">\n\n              <img src = \"".concat(meal.strMealThumb, "\" alt = \"").concat(meal.strMeal, "\">\n              <div class = 'meal-info' data-mealID = \"").concat(meal.idMeal, "\">\n                <h3 id=\"meal-name\">").concat(meal.strMeal, "</h3>\n              </div>\n          </div>");
        }).join('');
      }
...
function addMealToDom(meal) {
  ...
  single_mealEl.innerHTML = "\n  <div class=\"single-meal\">\n    <h1>".concat(meal.strMeal, "</h1>\n    <img src =\"").concat(meal.strMealThumb, " \"  alet = \"").concat(meal.strMeal, "\"/>\n    <div class = \"single-meal-info\">\n\n    ").concat(meal.strCategory ? "<p>".concat(meal.strCategory, "</p>") : '', "\n    ").concat(meal.strArea ? "<p>".concat(meal.strArea, "</p>") : '', "\n    </div>\n    <div>\n      <p id=\"instr\">").concat(meal.strInstructions, "</p>\n    </div>\n    <h2>Ingredients:</h2>\n    <ul>\n\n    ").concat(ingredients.map(function (ing) {
    return "\n        <li>".concat(ing, "</li>\n      ");
  }).join(''), "\n\n    </ul>\n  </div>\n");
}
